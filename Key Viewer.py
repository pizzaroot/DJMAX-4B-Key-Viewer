        ...
        if mode == 8:
            for i in range(2):
                for j in range(0, len(events8[i + 6]), 2):
                    pygame.draw.rect(screen, (255,0,0), (i * 252, (curtime - events8[i + 6][j]) * 180 * velocity, 252, 15))
            for i in range(6):
                for j in range(0, len(events8[i]), 2):
                    if i % 3 == 1:
                        pygame.draw.rect(screen, (0,0,255), (i * 84, (curtime - events8[i][j]) * 180 * velocity, 84, 15))
                    else:
                        pygame.draw.rect(screen, (255,255,255), (i * 84, (curtime - events8[i][j]) * 180 * velocity, 84, 15))
        elif mode == 6:
            for i in range(6):
                for j in range(0, len(events6[i]), 2):
                    if i % 3 == 1:
                        pygame.draw.rect(screen, (0,0,255), (i * 84, (curtime - events6[i][j]) * 180 * velocity, 84, 15))
                    else:
                        pygame.draw.rect(screen, (255,255,255), (i * 84, (curtime - events6[i][j]) * 180 * velocity, 84, 15))
        elif mode == 4:
            for i in range(4):
                for j in range(0, len(events4[i]), 2):
                    if i == 1 or i == 2:
                        pygame.draw.rect(screen, (0,0,255), (i * 126, (curtime - events4[i][j]) * 180 * velocity, 126, 15))
                    else:
                        pygame.draw.rect(screen, (255,255,255), (i * 126, (curtime - events4[i][j]) * 180 * velocity, 126, 15))
        elif mode == 5:
            for i in range(2):
                for j in range(0, len(events5[i]), 2):
                    if i == 1:
                        pygame.draw.rect(screen, (0,0,255), (i * 101, (curtime - events5[i][j]) * 180 * velocity, 101, 15))
                    else:
                        pygame.draw.rect(screen, (255,255,255), (i * 101, (curtime - events5[i][j]) * 180 * velocity, 101, 15))
            for i in range(2):
                for j in range(0, len(events5[i + 2]), 2):
                    pygame.draw.rect(screen, (255,255,255), (i * 50 + 202, (curtime - events5[i + 2][j]) * 180 * velocity, 50, 15))
            for i in range(2):
                for j in range(0, len(events5[i + 4]), 2):
                    if i == 0:
                        pygame.draw.rect(screen, (0,0,255), (i * 101 + 302, (curtime - events5[i + 4][j]) * 180 * velocity, 101, 15))
                    else:
                        pygame.draw.rect(screen, (255,255,255), (i * 101 + 302, (curtime - events5[i + 4][j]) * 180 * velocity, 101, 15))
